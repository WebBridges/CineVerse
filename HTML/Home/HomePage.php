                ...
                <template id="template-posts">
                    ...
                    <div class="post-body">
                        ...
                        <div class="post-actions row mt-3">
                            ...
                            <div class="col-2">
                                <button class="btn comments-button" data-bs-toggle="modal" data-bs-target="#comments-modal" data-bs-dismiss="modal">
                                    <em class="fa-regular fa-comment" style="color: #ffffff;"></em>
                                </button>
                            </div>
                            <div class="col-8 post-description-container">
                                <p class="white-text post-description">Post description can be very long and take the whole page</p>
                            </div>
                        </div>
                    </div>
        ...
        <nav class="navbar navbar-custom fixed-bottom navbar-expand mx-auto bottom-navbar border border-1 border-light">
            ...
            <div class="collapse navbar-collapse" id="bottomNavbarNav">
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                     <a class="nav-link" href="../Profile/CreatePost.php">
