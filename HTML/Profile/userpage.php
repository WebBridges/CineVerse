...
<body>
    <div class="container-fluid p-0 overflow-x-hidden overflow-y-auto" id="body_container">
        <header id="profile_header">
            ...
            <img src="../../img/default-background.jpg" alt="background profile image"
                class="img-fluid overflow-hidden border-top border-2 border-black" id="background_image">
        </header>
            ...
            <div id="posts-section">
                <div class="row g-0" id="buttons">
                    <div class="col-4 photo_button">
                        <button type="button"
                            class="btn btn-default current_button border border-black border-2 rounded-0"
                            id="photo_button">Photo</button>
                    </div>
                    <div class="col-4 text_button">
                        <button type="button" class="btn btn-default border border-black border-2 rounded-0"
                            id="text_button">Text</button>
                    </div>
                    <div class="col-4 survey_button">
                        <button type="button" class="btn btn-default border border-black border-2 rounded-0"
                            id="survey_button">Survey</button>
                    </div>
                </div>
        ...
        <nav class="navbar navbar-custom fixed-bottom navbar-expand mx-auto bottom-navbar border border-1 border-light">
            <div class="collapse navbar-collapse" id="bottomNavbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="SearchPage.php" title="SearchPage">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="CreatePost.php" title="CreatePost">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="userpage.php" title="Userpage">
                            <svg xmlns="http://www.w3.org/2000/svg" width="49.5" height="48.75" viewBox="0 0 66 65"
                                fill="none">
                                <path
                    ...
                    <div class="row">
                        <div class="col-auto">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" data-bs-toggle="modal"
                                data-bs-target="#post-modal"></button>
                        </div>
                    </div>
                </div>
                <div class="modal-body">
