        ...
        <div class="container-fluid d-flex flex-column justify-content-center align-items-center pt-5">
            ...
            <div id="MainBlock" class="col-md-4 col-9">
                ...
                <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                    <a href="../Post/PhotoVideoPost.php" class="btn btn-primary mt-5 mb-4 pt-1 pb-2">Post con immagine / video</a>
                    <a href="../Post/TextPost.php" class="btn btn-primary mt-4 mb-4 pt-1 pb-2">Post testuale</a>
                    <a href="../Post/SurveyPost.php" class="btn btn-primary mt-4 mb-5 pt-1 pb-2">Sondaggio</a>
                </div>
            </div>
            <!--Navbar-->
