...
<head>
    ...
    <div class=" container-fluid d-flex vh-100 justify-content-center">
            <div class="  col-md-6 col-sm-7 col-9 col-lg-4">
                ...
                <div class=" col-12 d-flex flex-column align-items-center justify-content-center mt-4" id="usersList">
        ...
        <script src="../../JAVASCRIPT/Profile/FollowerFollowing.js"></script>
    </body>
</html>