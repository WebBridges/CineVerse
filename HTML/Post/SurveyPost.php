...
<html lang="it">
    ...
    <body>
        <div id="page" class="container-fluid d-flex flex-column justify-content-center align-items-center pt-2 pt-md-5">
            <div class="justify-content-center align-items-center">
                <h1>CineVerse</h1>
            </div>

            <div id="MainBlock" class="col-md-7 col-10 pb-3 ">
                    ...
                    <div class="row">
                        <div class="col-lg-6 px-5">
                            <div class="col-lg-10 col-md-9 col-8 mt-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="postTitle" name="postTitle" maxlength="50" placeholder="Inserisci il titolo del post" title="TitoloInput">
                            </div>
                            <div class="mt-2">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="radio" name="optionType" id="radioOption" value="radio" checked title="Scelta singola">
                                </div>
                                <div class="form-check">
                        ...
                        <div class="col-lg-6 px-5">
                            <div class="form-group col-12 mt-2 mb-3">
                                <label class="form-label mb-1 " for="postField">Campi</label>
                                <label class="visually-hidden" for="field1">Campo 1</label>
                                <input type="text" class="form-control" maxlength="30" id="field1" name="field1" placeholder="Inserisci il primo campo" title="Campo 1">
                                <label class="visually-hidden" for="field2">Campo 2</label>
                                <input type="text" class="form-control mt-2" maxlength="30" id="field2" name="field2" placeholder="Inserisci il secondo campo" title="Campo 2">
                                <label class="visually-hidden" for="field3">Campo 3</label>
                                <input type="text" class="form-control mt-2" maxlength="30" id="field3" name="field3" placeholder="Inserisci il terzo campo" hidden title="Campo 3">
                                <label class="visually-hidden" for="field4">Campo 4</label>
                                <input type="text" class="form-control mt-2" maxlength="30" id="field4" name="field4" placeholder="Inserisci il quarto campo" hidden title="Campo 4">
